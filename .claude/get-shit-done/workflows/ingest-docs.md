...
```bash
INIT=$(node "/Users/radekmuzikant/Documents/elio/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/radekmuzikant/Documents/elio/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
