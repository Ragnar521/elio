...
```
Task(
  prompt="Read /Users/radekmuzikant/Documents/elio/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/radekmuzikant/Documents/elio/.claude/get-shit-done/templates/VALIDATION.md`
