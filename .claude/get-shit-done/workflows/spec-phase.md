...
```bash
INIT=$(node "/Users/radekmuzikant/Documents/elio/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/radekmuzikant/Documents/elio/.claude/get-shit-done/templates/spec.md.
