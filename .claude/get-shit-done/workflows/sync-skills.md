...
INSTALL_JS_GLOBAL="/Users/radekmuzikant/Documents/elio/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/radekmuzikant/Documents/elio/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
